...
earnings_df = et.get_eurostat_dataset(
    ...
    filters=f"A.EUR+PPS.NET+TAX+SOC+GRS+TOTAL.P1_NCH_AW50+P1_NCH_AW67+P1_NCH_AW100+P1_NCH_AW167+CPL_CH2_AW100+CPL_CH2_AW100_100+CPL_NCH_AW100_100+CPL_NCH_AW100_33+CPL_CH2_AW100_33.",
...
taxrate_df = et.get_eurostat_dataset(
    ...
    filters=f"A.P1_NCH_AW50+P1_NCH_AW67+P1_NCH_AW100+P1_NCH_AW167+CPL_CH2_AW100+CPL_CH2_AW100_100+CPL_NCH_AW100_100+CPL_NCH_AW100_33+CPL_CH2_AW100_33.",
    start_year=start_year,
    end_year=end_year
)
