...
pop_df = et.get_eurostat_dataset(
    ...
    filters=f"A.DEPRATIO1+OLDDEP1+YOUNGDEP1+MEDAGEPOP+FMEDAGEPOP+MMEDAGEPOP+PC_FM+PC_Y0_14+PC_Y0_4+PC_Y0_18+PC_Y10_14+PC_Y15_19+PC_Y15_24+PC_Y15_29+PC_Y15_74+PC_Y20_24+PC_Y20_39+PC_Y20_64+PC_Y25_29+PC_Y25_44+PC_Y25_49+PC_Y30_34+PC_Y35_39+PC_Y40_44+PC_Y40_59+PC_Y45_49+PC_Y45_64+PC_Y50_54+PC_Y50_64+PC_Y55_59+PC_Y5_9+PC_Y60_64+PC_Y60_79+PC_Y60_MAX+PC_Y65_69+PC_Y65_79+PC_Y65_MAX+PC_Y70_74+PC_Y75_79+PC_Y75_MAX+PC_Y80_84+PC_Y80_MAX+PC_Y85_MAX+PC_Y100_MAX.",
...
poptot_df = et.get_eurostat_dataset(
    ...
    filters=f"A.AVG+CNMIGRAT+GROWRT+NATGROWRT+POPTRT.",
    start_year=start_year,
    end_year=end_year
)
...
fertility_df = et.get_eurostat_dataset(
    ...
    filters=f"A.AGEMOTH+AGEMOTH1+AGEMOTH2+AGEMOTH3+AGEMOTH4_MAX+LBIRTHR1PC+LBIRTHR2PC+LBIRTHR3PC+LBIRTHR4_MAXPC+MEDAGEMOTH+NMARPCT+TOTFERRT.",
    start_year=start_year,
    end_year=end_year
)
...
#     filters=f"A.NAT+TOTAL+EU28_FOR+NEU28_FOR+EFTA_FOR+EXT_FOR_HDI_VH+EXT_FOR_HDI_H+EXT_FOR_HDI_L+EXT_FOR_HDI_M..NR..",
#     start_year=start_year,
#     end_year=end_year
# )
