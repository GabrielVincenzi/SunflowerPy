...
govexp_df = et.get_eurostat_dataset(
    ...
    filters=f"A.MIO_EUR+PC_GDP+PC_TOT.S13.GF01+GF0101+GF0104+GF0107+GF02+GF0203+GF03+GF0301+GF0302+GF0303+GF0304+GF04+GF05+GF06+GF07+GF0704+GF08+GF09+GF0901+GF0902+GF0903+GF0904+GF10+GF1001+GF1002+GF1003+GF1004+GF1005+GF1006.TE.{countries}",
...
govtax_df = et.get_eurostat_dataset(
    ...
    filters=f"A.MIO_EUR+PC_GDP+PC_TOT.S13.D2+D211+D51+D91.{countries}",
    start_year=start_year,
    end_year=end_year
)
...
gov_df = pd.merge(govexp_df, govtax_df, how='outer', on=[k.lower() for k in keys])
